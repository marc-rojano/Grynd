                ...
                <main className="page-content">
                    <section className="hero-card placeholder-card">
                        <div className="hero-copy">
                            ...
                            <h1 className="page-title">Hola, soy FeaturesPage</h1>
                            <p className="page-subtitle">
                                Aquí irán las funciones de la app cuando se defina el diseño final. Por ahora solo sirve para comprobar que la navegación funciona.
                            </p>
